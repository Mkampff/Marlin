...
// END MODIF filament
#define DEFAULT_MAX_ACCELERATION      {200,200,100,250}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
