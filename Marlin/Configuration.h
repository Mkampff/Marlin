...
#define STRING_CONFIG_H_AUTHOR "(Kikai Labs, T105 v1.20130719)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,96.59}  // default steps per unit
